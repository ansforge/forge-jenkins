...
JENKINS_OPTS="--prefix=/jenkins -Xms3072m -Xmx6144m -XX:MaxPermSize=512m -Djava.awt.headless=true -jar /usr/share/jenkins/jenkins.war --handlerCountMax=100 --handlerCountMaxIdle=20 --debug=5"
EOH
      }
